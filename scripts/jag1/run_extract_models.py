...
HA = AT.get_models_to_extract('gsm_sel/good_scoring_models_A_cluster'+str(c)+'_detailed.csv')
HB = AT.get_models_to_extract('gsm_sel/good_scoring_models_B_cluster'+str(c)+'_detailed.csv')
