'''
Script for integrative modeling of Notch1-JAG1 complex
...
# Topology File
topology_file = "/home/arastu/notch/jag1/topology_notch1_jag1_rigid.txt"
...
jag1_tm_bead = IMP.atom.Selection(
        root_hier, molecule="jag1", residue_indexes=range(1068,1094)).get_selected_particles()[0]

IMP.core.XYZ(jag1_tm_bead).set_coordinates(IMP.algebra.Vector3D(0,1500,0))

# First select and gather all particles to fix.
fixed_particles = []
fixed_particles.append(notch1_tm_bead)

fixed_particles.append(jag1_tm_bead)
...
#Distance restraint to keep Notch straight
dsr7 = IMP.pmi.restraints.basic.DistanceRestraint(tuple_selection1=(20,20,"notch1",0),tuple_selection2=(1735,1735,"notch1",0),distancemax=865,distancemin=845,root_hier=root_hier)
dsr7.add_to_model()
output_objects.append(dsr7)
...
IMP.pmi.tools.shuffle_configuration(root_hier,
                                    max_translation=100,
                                    excluded_rigid_bodies=[notch1_tm_bead,jag1_tm_bead])

#TODO MAKE MAX_TRANS higher (Made 100 from 50)
#TODO add fixed particles to list of excluded particles in shuffle 
